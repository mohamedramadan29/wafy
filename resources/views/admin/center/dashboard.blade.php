...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="left-content">
            <div>
                <h2 class="main-content-title tx-24 mg-b-1 mg-b-lg-1">مرحبا
                    , {{Auth::guard('center')->user()->name   }} </h2>
    ...
    <div class="row row-sm">
        ...
        <div class="col-xl-3 col-lg-6 col-md-6 col-xm-12">
            <div class="card overflow-hidden sales-card bg-primary-gradient">
                <div class="pl-3 pt-3 pr-3 pb-2 pt-0">
                    <div class="">
                        <h6 class="mb-3 tx-12 text-white"> العمليات الخاصة بالمركز </h6>
                    </div>
                    <div class="pb-0 mt-0">
                        <div class="d-flex">
                            <div class="">
                                <h4 class="tx-20 font-weight-bold mb-1 text-white"> @php echo count(\App\Models\front\Order::where('inspection_center',\Illuminate\Support\Facades\Auth::guard('center')->id())->get()) @endphp  </h4>
                                <a href="{{url('center/transactions')}}" class="mb-0 tx-12 text-white op-7"> مشاهدة
                                    التفاصيل </a>
                            </div>
                        </div>
                    </div>
        ...
        <div class="col-xl-3 col-lg-6 col-md-6 col-xm-12">
            <div class="card overflow-hidden sales-card bg-danger-gradient">
                <div class="pl-3 pt-3 pr-3 pb-2 pt-0">
                    <div class="">
                        <h6 class="mb-3 tx-12 text-white"> انواع الفحص </h6>
                    </div>
                    <div class="pb-0 mt-0">
                        <div class="d-flex">
                            <div class="">
                                <h4 class="tx-20 font-weight-bold mb-1 text-white"> @php echo count(\App\Models\admin\InspectionType::where('center_id',\Illuminate\Support\Facades\Auth::guard('center')->id())->get()) @endphp </h4>
                                <a href="{{url('center/inspection-type/'.\Illuminate\Support\Facades\Auth::guard('center')->id())}}"
                                   class="mb-0 tx-12 text-white op-7"> مشاهدة التفاصيل </a>
                            </div>
                        </div>
                    </div>
                </div>
