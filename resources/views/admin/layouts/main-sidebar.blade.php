...
<aside class="app-sidebar sidebar-scroll">
    ...
    <div class="main-sidemenu">
        ...
        <ul class="side-menu">
            ...
            <li class="slide">
                <a class="side-menu__item" href="{{ url('/' . ($page = 'center/dashboard')) }}">
                    <svg
            ...
            @if(Auth::guard('center')->check())
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                        <li><a class="slide-item" href="{{url('center/update_admin_password')}}"> تعديل كلمة المرور </a>
                        </li>
                        <li><a class="slide-item" href="{{url('center/update_admin_details')}}"> تعديل البيانات </a></li>
                    </ul>
                </li>
            @elseif(Auth::check())
                <li class="side-item side-item-category"> مراكز الصيانة   </li>
                <li class="slide">
                    <a class="side-menu__item" data-toggle="slide" href="">
                        <i style="font-size: 22px;margin-left: 10px" class="fa fa-folder-open"></i>
                        <span class="side-menu__label">   مراكز الصيانة  </span><i
                            class="angle fe fe-chevron-down"></i></a>
                    <ul class="slide-menu">
                ...
                <li class="side-item side-item-category"> الاسئلة الشائعة  </li>
                <li class="slide">
                    <a class="side-menu__item" data-toggle="slide" href="">
                        <i style="font-size: 22px;margin-left: 10px" class="fa fa-users"></i>
